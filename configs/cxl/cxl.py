...
system.cpu1.isa=X86ISA()
system.cpu1.createInterruptController()
system.cpu1.interrupts[0].pio = system.membus2.mem_side_ports
system.cpu1.interrupts[0].int_requestor = system.membus2.cpu_side_ports
system.cpu1.interrupts[0].int_responder = system.membus2.mem_side_ports
...
# system.cxllink = CXLLink(lanes = 2, speed = 5, mps=5, max_queue_size= 10)
# system.cxllink.downstreamRequest= system.mem_ctrl.port
# system.cxllink.upstreamRequest=system.mem_ctrl3.port
# system.cxllink.downstreamRequest= system.cxlswitch.mem_side_port
